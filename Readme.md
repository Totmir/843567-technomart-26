...
* Студент: [Александр](https://up.htmlacademy.ru/htmlcss/26/user/843567).
* Наставник: `Сам Сусам`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/843567-technomart-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
